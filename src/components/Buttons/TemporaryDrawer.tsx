            ...
            <>
                <SvgIcon sx={{ fontSize: 60 }} viewBox="0 0 256 256" width="100%" height="100%" version="1.1"
                    ...
                    <g id="Obs">
                        <g>
                            <clipPath id="_clip1">
                                <rect x="45.5" y="52.5" width="165" height="86.5" style={{fill: "#ffffff", stroke: "rgb(0,0,0)"}}/>
                            </clipPath>
            ...
            <List >
                {['The Observatory', 'The Fields', 'The workshop', 'The Old Cave'].map((text, index) => (
                    <ListItem key={text} button  sx={{textAlign:'center',display: 'block'}}>
                        ...
                        <ListItemText className="link-drawer" primary={text} sx={{fontWeight:'900',cursor:index===0?"normal":"not-allowed"}}/>
                    </ListItem>
                ))}
            </List>
            <Divider/>
